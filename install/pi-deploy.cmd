...
rem
rem 3. Copy \bin\Release\net10.0\linux-arm\publish\ to RPi /home/vlad/web/publish 
rem    (make sure FileZilla transfers all files including files without extensions as binary files)
rem
rem 4. sudo bash -c "$(wget -q -O - https://raw.githubusercontent.com/vkirienko/VKirienkoSite/master/install/install.sh)"
rem
